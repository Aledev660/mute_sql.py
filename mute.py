#mute
@ubot.on(events.NewMessage(outgoing=True, pattern=r"mute ?(\d+)?"))
@ubot.on(events.NewMessage(pattern=r"mute ?(\d+)?"))
...
@ubot.on(events.NewMessage(outgoing=True, pattern=r"unmute ?(\d+)?"))
@ubot.on(events.NewMessage(pattern=r"unmute ?(\d+)?"))
